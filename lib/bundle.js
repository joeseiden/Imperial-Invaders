...
var _player_ship = __webpack_require__(8);

var _player_ship2 = _interopRequireDefault(_player_ship);

var _enemy_ship = __webpack_require__(6);
...
var GameView = function () {
  ...
  _createClass(GameView, [{
    ...
    key: "bindStartKeyHandler",
    value: function bindStartKeyHandler() {
      var _this = this;

      var that = this;
      document.addEventListener('keydown', function (e) {
        if (e.keyCode === 32 && _this.playing === false) {
          that.start();
        }
      });
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  new _game_view2.default(game, ctx).startScreen();
});
